package com.xuangand.rhythmoflife.Api;



import com.xuangand.rhythmoflife.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            AppId = String.valueOf(ZaloPayInfo.APP_ID);
            ...
            Mac = Helpers.getMac(ZaloPayInfo.MAC_KEY, inputHMac);
        }
    }
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = HttpProvider.sendPost(ZaloPayInfo.URL_CREATE_ORDER, formBody);
        return data;
    }
}
